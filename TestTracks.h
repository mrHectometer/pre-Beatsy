...
void init_track1()
{
	...
	//kick
	Track[t].setEntry(0, 0, 1);
	Track[t].setEntry(8, 0, 1);
	Track[t].setEntry(10, 0, 1);
	//snare
	Track[t].setEntry(4, 1, 1);
	Track[t].setEntry(11, 1, 1);
	Track[t].setEntry(12, 1, 1);
	Track[t].setEntry(14, 1, 1);
	//hats
	for(int i = 0; i < 16; i+=2)
	{
		Track[t].setEntry(i, 2, 1);
...
void init_track6()
{
	...
	Track[t].setEntry(7, 3, 1);
	Track[t].setEntry(9, 3, 1);
}
void init_track7()
{
	int t = 7;
